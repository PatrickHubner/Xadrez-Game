...
public interface UI {
	/*
	 * Codigo ANSI pego no seguinte link;
	...
	/*
	 * Codigo para limpar a tela pego no seguinte link;
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		try {
			...
			throw new InputMismatchException("ERRO AO LER OS VALORES");
		}
	}
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		...
		if (!chessMatch.getCheckMate()) {
			...
			System.out.println("CHEQUE MATE OTARIO, PERDEU");
